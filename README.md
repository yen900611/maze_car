...
* `end`：終點座標。因遊戲回傳格式有誤，此座標數值需乘以五倍，方可匹配上述玩家車子的座標系統。
  以小試身手第二關為例，玩家收到的終點座標為(3, -3)，這是因為終點位在迷宮中的(3, -3)的格子。然而當車子碰觸終點時，車子會在(7, -3)的格子，座標會顯示在(35, -15)附近。
  ![](https://i.imgur.com/TvODurX.png)
